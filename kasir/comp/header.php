...
<?php foreach (summon_admin() as $key) : ?>
  ...
  <head>
    ...
    <!-- logo -->
    <link rel="icon" type="image/png" href="<?= url() ?>img/bakso1.png">
    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index.php" class="brand-link">
          <img src="<?= url() ?>img/bakso1.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
          <span class="brand-text font-weight-light">BAKSO'RAN</span>
        </a>
