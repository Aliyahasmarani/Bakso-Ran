                  ...
                  <div class="modal-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="kdproduk" autofocus name="kdproduk" aria-describedby="emailHelp">
                      </div>
                      <div class="form-group">
                        <label for="nm_produk">Nama Produk</label>
                        <input type="text" class="form-control" id="nm_produk" name="nm_produk" aria-describedby="emailHelp">
                      </div>
                      <div class="form-group">
                        ...
                        <select name="kategori" class="form-control">
                          ...
                          ?>
                            <option><?php echo $kat['kategori'] ?></option>
                          <?php endforeach; ?>
                        </select>
                      </div>
                      <div class="form-group">
                        <label for="stok">Stok</label>
                        <input type="text" class="form-control" id="stok" name="stok" aria-describedby="emailHelp">
                      </div>
